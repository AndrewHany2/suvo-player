    ...
    return (
      <YStack flex={1} backgroundColor="#0f0f23">
        <XStack alignItems="center" gap={14} paddingHorizontal={48} paddingVertical={18} borderBottomWidth={1} borderBottomColor="#2a2a4e">
          <YStack paddingVertical={8} paddingHorizontal={14} backgroundColor="#1a1a2e" borderRadius={8} cursor="pointer" onPress={() => setShowEpisodes(false)} pressStyle={{ opacity: 0.8 }}>
            <Text color="#e94560" fontSize={14} fontWeight="600">← Back</Text>
          </YStack>
          <Text color="#fff" fontSize={20} fontWeight="700" flex={1} numberOfLines={1}>{seriesName}</Text>
        </XStack>
        <SectionList
          sections={sections}
    ...
    <ScrollView flex={1} backgroundColor="#0f0f23" contentContainerStyle={{ paddingBottom: 80 }}>
      <YStack width="100%" height={520} position="relative">
        ...
        <YStack position="absolute" bottom={0} left={48} right={48} zIndex={5} paddingBottom={40}>
          <Text color="#fff" fontSize={40} fontWeight="900" letterSpacing={-1} marginBottom={12}>{seriesName}</Text>
          ...
          <XStack alignItems="center" gap={12} flexWrap="wrap">
            {historyEntry && (
              <YStack backgroundColor="#fff" paddingHorizontal={28} paddingVertical={13} borderRadius={8} cursor="pointer" onPress={handleContinue} pressStyle={{ opacity: 0.85 }} hoverStyle={{ opacity: 0.9 }} animation="quick">
