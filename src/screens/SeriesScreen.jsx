    ...
    <YStack paddingTop={20} paddingBottom={8} onLayout={handleLayout}>
      ...
      {shelf.items === null ? (
        ...
        >
          ...
          {shelf.loadingMore && <YStack width={60} justifyContent="center" alignItems="center"><Spinner size="small" color="#e94560" /></YStack>}
        </ScrollView>
      )}
    </YStack>
  );
...
function CategoryPage({ name, items, onBack, onPress, onLoadMore, hasRemote, loadingMore }) {
  ...
  return (
    <YStack flex={1} backgroundColor="#0f0f23">
      ...
      <Input margin={12} placeholder="Search titles..." placeholderTextColor="#555" value={search} onChangeText={setSearch} backgroundColor="#1a1a2e" color="#fff" borderRadius={10} paddingHorizontal={14} paddingVertical={10} fontSize={14} borderWidth={1} borderColor="#2a2a4e" />
      {!displayed ? (
        ...
        <FlatList
          ...
          ListFooterComponent={(hasMore || loadingMore) ? <YStack alignItems="center" paddingVertical={20}><Spinner size="small" color="#e94560" /></YStack> : null}
